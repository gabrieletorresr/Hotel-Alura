...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtDataS.addPropertyChangeListener(new PropertyChangeListener() {
			...
			private void calcularValor(JDateChooser txtDataE, JDateChooser txtDataS) {
	...
	public void salvarReserva() {
		String dataEntrada = ((JTextField)( txtDataE.getDate)).getText();
		String dataSaida = ((JTextField)(txtDataS.getDate())).getText();
