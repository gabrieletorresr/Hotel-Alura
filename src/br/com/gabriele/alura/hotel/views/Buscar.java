...
public class Buscar extends JFrame {
	...
	public Buscar() {
		...
		panel.addTab("Reservas", new ImageIcon(Buscar.class.getResource("/img/reservado.png")), scroll_table,
				null);
		...
		panel.addTab("Hóspedes", new ImageIcon(Buscar.class.getResource("/img/pessoas.png")),
				scroll_tableHuespedes, null);
		scroll_tableHuespedes.setVisible(true);
		prencherTabelaHospede();

		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Buscar.class.getResource("/img/Ha-100px.png")));
